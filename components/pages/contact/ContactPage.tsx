    ...
    <main className="min-h-screen py-16 px-4 sm:px-6 md:px-8 bg-sand">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          {/* Form Card (5 Cols) */}
          <div className="lg:col-span-5 bg-white/70 backdrop-blur-sm p-6 sm:p-8 rounded-3xl border border-alabaster shadow-sm flex flex-col justify-between">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-white/70 backdrop-blur-sm p-6 sm:p-8 rounded-3xl border border-alabaster shadow-sm flex flex-col justify-between h-full space-y-6"
              >
                <div>
                  <div className="space-y-1">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6 text-charcoal/80 font-sans font-light text-sm border-t border-alabaster/60 pt-6 mt-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-3 items-start">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-gold hover:text-gold/80 transition-colors">
                            <a href={`mailto:${activeProperty.email}`}>{activeProperty.email}</a>
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                {/* Map Wrapper */}
                <div className="relative aspect-[16/10] sm:aspect-[16/9] rounded-2xl overflow-hidden border border-alabaster/80 shadow-inner flex-grow">
                  <iframe

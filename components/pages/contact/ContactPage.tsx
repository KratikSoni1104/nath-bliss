      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <p className="text-charcoal/80 font-sans font-light text-center md:text-left text-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <motion.div whileHover={{ scale: 1.01 }}>
                <Input
                  ...
                  required
                  className="h-14 text-base bg-white border-alabaster focus:border-gold focus:ring-0 rounded-xl shadow-sm transition-colors"
                />
              </motion.div>
              ...
              <motion.div whileHover={{ scale: 1.01 }}>
                <Textarea
                  ...
                  required
                  className="min-h-[150px] text-base bg-white border-alabaster focus:border-gold focus:ring-0 rounded-xl shadow-sm transition-colors"
                />
              </motion.div>
              ...
              <Button
                ...
                variant="custom"
                size="custom"
                className="w-full btn-primary h-14 text-lg font-cinzel"
              >
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl border border-alabaster">
              <h2 className="font-cinzel text-2xl text-gold mb-6">
                Reach Us Directly
              </h2>

              <div className="space-y-6 text-charcoal/80 font-sans font-light">
            ...
            {/* Map */}
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-alabaster">
              <iframe

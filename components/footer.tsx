      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="flex items-center gap-2 font-playfair text-xl text-gold">
              <Hotel className="h-6 w-6 text-gold" />
              <span className="tracking-wide">NathBliss Hotels</span>
            </div>
            <p className="font-sans font-light text-sm leading-relaxed text-[#e6ded4]/80">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h4 className="font-cinzel font-semibold text-base tracking-wider text-gold">
              Explore
            </h4>
            <nav className="flex flex-col gap-2.5 font-sans font-light text-sm text-[#e6ded4]/80">
              <Link href="/" className="hover:text-gold transition-colors">
                Home
              </Link>
              <Link href="/hotels" className="hover:text-gold transition-colors">
                Our Stays
              </Link>
              <Link href="/explore" className="hover:text-gold transition-colors">
                Local Guide
              </Link>
          ...
          >
            ...
            <div className="space-y-3 font-sans font-light text-sm text-[#e6ded4]/80">
          ...
          >
            ...
            <p className="font-sans font-light text-xs leading-relaxed text-[#e6ded4]/70">
            ...
            <div className="pt-1">
              <Link
                ...
                className="inline-flex w-full justify-center items-center bg-gold hover:bg-gold/90 text-charcoal font-cinzel font-semibold text-xs tracking-widest py-3 rounded-xl transition-all shadow-sm"
              >
                Book Your Stay
              </Link>
            </div>
            ...
            <div className="space-y-2 pt-2">
              <p className="text-[10px] font-cinzel text-gold tracking-widest font-semibold">CONNECT DIRECTLY</p>
              <div className="flex gap-4">
                ...
                <a
                  ...
                  className="p-2.5 bg-white/5 hover:bg-white/10 hover:text-gold rounded-xl transition-all text-[#e6ded4]"
                >
                ...
                <a
                  ...
                  className="p-2.5 bg-white/5 hover:bg-white/10 hover:text-emerald-500 rounded-xl transition-all text-[#e6ded4]"
                >
                  <svg className="h-4.5 w-4.5 fill-current" viewBox="0 0 24 24" width="18" height="18">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#e6ded4]/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#e6ded4]/60">
